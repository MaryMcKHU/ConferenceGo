              ...
              <div className="shadow p-4 mt-4">
                ...
                <form onSubmit={this.handleSubmit} id="create-presentation-form">
                  ...
                  <div className="form-floating mb-3">
                    ...
                    placeholder="Presenter email" required type="email" 
                    name="presenter_email" id="presenter_email" className="form-control"
                  ...
                  <div className="form-floating mb-3">
                    ...
                    id="company_name" className="form-control"
                    value={this.state.companyName} />
                    <label htmlFor="company_name">Company name</label>
                  </div>
                  <div className="form-floating mb-3">
                    <input onChange={this.handleTitleChange} 
                    placeholder="Title" required type="text" name="title" 
                  ...
                  <div className="mb-3">
                    ...
                    className="form-control" id="synopsis" rows="3" 
                    name="synopsis"
                  ...
                  <div className="mb-3">
                    ...
                    required name="conference" id="conference" 
