              ...
              <div className="shadow p-4 mt-4">
                ...
                <form onSubmit={this.handleSubmit} id="create-location-form">
                  ...
                  <div className="form-floating mb-3">
                    ...
                    id="room_count" className="form-control" value={this.state.roomCount}/>
                    <label htmlFor="room_count">Room count</label>
                  </div>
                  <div className="form-floating mb-3">
                    <input onChange={this.handleCityChange} placeholder="City" required type="text" 
                    name="city" id="city" className="form-control" value={this.state.city}/>
                    <label htmlFor="city">City</label>
                  </div>
                  <div className="mb-3">
                    <select required id="state" className="form-select" name="state" 
